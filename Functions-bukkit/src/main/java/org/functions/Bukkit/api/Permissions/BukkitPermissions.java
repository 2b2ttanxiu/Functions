...
public class BukkitPermissions {
    ...
    public BukkitPermissions(Functions plugin) {
    ...
    public void updatePermissions(Player player, String world) {
        ...
        List<String> playerPermArray = new ArrayList<>(new Data(player.getUniqueId()).getPermissionManager().getPermissions());
         ...
         * and the player has the 'functions.noofflineperms' permission.
         */
    ...
    private List<String> sort(List<String> permList) {
        ...
        for (String key : permList) {
            ...
            if (!key.isEmpty()) {
                ...
                Map<String, Boolean> allchildren = Functions.instance.getAPI().getBukkitPermissions().getAllChildren(a, new HashSet<>());
                if (allchildren != null) {
